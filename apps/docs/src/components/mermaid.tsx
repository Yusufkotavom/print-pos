...
export function Mermaid({ chart }: { chart: string }) {
	...
	const zoomControls = (
		<div className="absolute right-3 bottom-3 flex items-center gap-0.5 rounded-lg border bg-fd-card/90 p-0.5 shadow-sm backdrop-blur-sm">
			<button
				type="button"
				onClick={zp.zoomOut}
				className={btnClass}
			...
			<span className="min-w-[3ch] select-none text-center text-fd-muted-foreground text-xs tabular-nums">
				{zp.pct}%
			</span>
			<button
				type="button"
